...
function App() {
  ...
  return (
    <div className="App flex flex-col justify-center items-center">
      ...
      <h1>Vite + React</h1>
      <div className="card">
        <button className="py-3 px-8 bg-sky-400 text-white rounded-[30px]" onClick={() => setCount((count) => count + 1)}>
          count is {count}
        </button>
        <p>
      ...
      <button className="py-3 px-5 bg-sky-400 text-white">Tailwind CSS</button>
...
const Button = (props) => {
  ...
  return (
    <>
      <button {...props} className={`${className} flex gap-x-2 items-center text-white px-4 py-2 rounded`}>
        {text || children}
      </button>
    </>
  );
